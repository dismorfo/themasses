...
Y.use('node', 'event', 'event-custom', 'imageloader', 'template-micro', 'escape', function(Y) {
    ...
    /** we need a default on error image, log that we cound't find this image? */    
    Y.on('error', function(e) {
        e.currentTarget.set('src', 'http://ortiz.bobst.nyu.edu/themasses/sites/dlib.nyu.edu.themasses/files/styles/dlts-book-image/public/masses001-fr01s.jpg');
    }, '.pane-books img');    
